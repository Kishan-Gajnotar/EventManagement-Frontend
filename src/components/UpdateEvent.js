        ...
        <div>
            <section class="py-5 text-center container">
                <div class="row lg-3" style={{ paddingTop: '20px', paddingBottom: '25px' }}>
                    <h1 class="fw-light" style={{ marginBottom: '30px' }}>Update Event</h1>
                    <Box
                        component="form"
                        sx={{
                ...
                <Button variant="contained" type="submit" style={{ padding: '10px 20px', marginRight: '10px' }} onClick={handleUpdate}>Update</Button>
                <Button variant="contained" type="submit" style={{ padding: '10px 20px' }} onClick={onCancelUpdate}>Cancle</Button>
            </section>
        </div>
    );
};
